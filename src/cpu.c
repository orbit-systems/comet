...
void exec_instruction(instruction_info* restrict ins) {
    ...
    case 0x01: // system control
        switch (ins->func) {
        case 0: // int
            phys_read_u64(comet.ic.ivt_base_address + 8*(ins->func % 256), &comet.cpu.registers[r_ip]);
            break;
        case 1:
        ...
        case 2: // fbf
            ...
            break;
        default:
            phys_read_u64(comet.ic.ivt_base_address + 8*int_invalid_instruction, &comet.cpu.registers[r_ip]);
            break;
        }
        break;
...
//     case 0x0a: // branch family
    ...
    case 0x0b: // push
        ...
        if (!success) phys_read_u64(comet.ic.ivt_base_address + 8*int_unaligned_access, &comet.cpu.registers[r_ip]);
        else
